...
//    float[] starpts = new float[NUM_STARS*2];
    ...
    public <val> PlayScreen(MainActivity act) {
        ...
        **/
        ...
        lblGlobalHigh = act.getResources().getString(R.string.global_high)+": ";
...
//            drawCenteredText(c, lblGlobalHigh + hiscore, statstextheight, p, 0);
...
//            drawCenteredText(c, lblLevel+levelnum, statstextheight2, p, 0);
            ...
            c.drawText(lblLevel+levelnum, width-rhstextoffset, statstextheight2, p);
            c.drawText(lblLives+lives, width-rhstextoffset, statstextheight, p);
